      ...
      <div class="px-4 sm:px-6 py-5 border-b border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-700/50">
        <div class="flex items-center justify-between gap-3">
          ...
          <Link
            ...
            class="shrink-0 text-sm font-semibold text-[#42b6c5] hover:text-[#35919e] whitespace-nowrap"
          >
...
const paymentSummariesTotal = page.props.paymentSummariesTotal ?? paymentSummaries.length
