            ...
            <div class="mb-6 flex items-center gap-4">
                ...
                <div class="min-w-0">
                    ...
                    <p class="mt-0.5 text-sm text-gray-500">
                        Start with the basics — you'll add content next.
                    </p>
                </div>
                <span
            ...
            >
                ...
                <div class="p-6 sm:p-8">
                    <div class="mb-6 flex items-center gap-3">
                        <div
                            class="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-[#381998]/10"
                        >
                        ...
                        <div>
                            ...
                            <p class="text-xs text-gray-500">
                                This will be your course's first impression.
                            </p>
                        </div>
                    </div>
                    ...
                    <form @submit.prevent="submit" class="space-y-5">
                        ...
                        <div>
                            ...
                            <div class="grid grid-cols-3 gap-2">
                                ...
                                >
                                    ...
                                    <span
                                        class="mt-0.5 block text-[11px] leading-tight text-gray-400"
                                        >{{ lvl.hint }}</span
                                    >
                                </button>
                            </div>
                        ...
                        <div>
                            ...
                            <div class="mt-1 flex items-center justify-between">
                                ...
                                <p
                                    ...
                                    :class="
                                        form.short_description.length > 450
                                            ? 'text-amber-500'
                                            : 'text-gray-400'
                                    "
                                >
                        ...
                        <!-- What's next hint -->
                        <div
                            class="flex items-start gap-2.5 rounded-xl bg-[#42b6c5]/[0.07] px-4 py-3"
                        >
                            <Sparkles
                            ...
                            >
                                ...
                                <strong
                                    ...
                                    >curriculum, pricing, and full
                                    description</strong
                                >
                                on the course builder. Your course stays a
                        ...
                        <!-- Actions -->
                        <div
                            class="flex items-center justify-between border-t border-gray-100 pt-5 dark:border-gray-700"
                        >
                            <Link
                                href="/tutor/courses"
