...
const expanded = ref<Set<number>>(
    new Set(props.course.sections.map((s: SectionRow) => s.id)),
);
...
const totalLessons = computed(() =>
    props.course.sections.reduce(
        (n: number, s: SectionRow) => n + s.lessons.length,
        0,
    ),
);
</script>
...
<template>
    ...
    >
        ...
        <div class="mx-auto max-w-6xl">
            ...
            >
                <div
                    class="absolute top-0 right-0 h-48 w-48 rounded-full bg-[#42b6c5]/15 blur-3xl"
                />
                <div class="relative grid gap-6 lg:grid-cols-5 lg:items-start">
                    <div class="lg:col-span-3">
                        <div class="mb-3 flex flex-wrap items-center gap-2">
                            ...
                            >
                                <component
                                    :is="categoryIconFor(course.category.icon)"
                                    v-if="categoryIconFor(course.category.icon)"
                                    class="h-3.5 w-3.5"
                                />
                        ...
                        <div
                            class="mt-5 flex flex-wrap items-center gap-5 text-sm text-gray-200"
                        >
                            <span
                        ...
                        <div class="mt-6 flex flex-wrap gap-3">
                            ...
                            >
                                <ExternalLink class="h-4 w-4" /> View on
                                catalogue
                            </a>
                        </div>
                    </div>
                    <div
                        class="relative aspect-video overflow-hidden rounded-xl border border-white/10 shadow-xl lg:col-span-2"
                    >
                        <img
                        ...
                        <div
                            v-else
                            class="flex h-full min-h-[160px] items-center justify-center bg-white/5"
                        >
            ...
            <div class="grid gap-8 lg:grid-cols-3">
                <div class="space-y-6 lg:col-span-2">
                    ...
                    >
                        <h2
                            class="mb-3 flex items-center gap-2 text-lg font-bold text-[#000928] dark:text-white"
                        >
                            <BookOpen class="h-5 w-5 text-[#42b6c5]" /> About
                            this course
                        </h2>
                        <div
                    ...
                    >
                        <h2
                            class="mb-4 flex items-center gap-2 text-lg font-bold text-[#000928] dark:text-white"
                        >
                            <Layers class="h-5 w-5 text-[#42b6c5]" /> Course
                            content
                        </h2>
                        <p
                        ...
                        <div v-else class="space-y-2">
                            ...
                            >
                                ...
                                >
                                    <span
                                        class="font-semibold text-[#000928] dark:text-gray-100"
                                        >{{ section.title }}</span
                                    >
                                    <ChevronDown
                                        :class="[
                                ...
                                <div
                                    v-show="expanded.has(section.id)"
                                    class="divide-y divide-gray-100 border-t border-gray-100 bg-white dark:divide-gray-700 dark:border-gray-700 dark:bg-gray-800"
                                >
                                    <div
                ...
                <div class="space-y-6">
                    <div
                        class="sticky top-6 rounded-xl border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800"
                    >
                        <h3
                            class="mb-4 text-sm font-bold tracking-wide text-gray-500 uppercase dark:text-gray-400"
                        >
                            Pricing
                        </h3>
                        <div class="mb-4">
                        ...
                        >
                            This course is not on the public catalogue until it
                            is published.
                        </p>
                        <Link
                            :href="`/tutor/courses/${course.id}/edit`"
                    ...
                    >
                        <h3
                            class="mb-2 text-sm font-bold tracking-wide text-gray-500 uppercase dark:text-gray-400"
                        >
                            Payment options
                        </h3>
                        <p class="text-sm text-gray-600 dark:text-gray-300">
                            Up to {{ maxInstallments }} installment(s)
                        </p>
                        <p
                            class="mt-1 text-sm text-gray-500 dark:text-gray-400"
                        >
                            ≈ {{ formatMoney(perInstallmentApprox) }} XAF per
                            installment
                        </p>
                    </div>
                    ...
                    >
                        <h3
                            class="mb-3 text-sm font-bold text-[#000928] dark:text-gray-100"
                        >
