    ...
    <div class="mx-auto max-w-3xl">
        ...
        <div class="mb-6 flex items-center justify-between">
            ...
            <div class="flex items-center gap-2">
                <Link
                    :href="`/tutor/live-classes/${liveClass.id}/edit`"
                    class="rounded-lg border border-gray-200 px-3 py-2 text-xs font-semibold text-[#381998] dark:border-gray-600"
                    >Edit</Link
                >
                <Link
                    :href="roomUrl"
        ...
        <div class="mb-4 grid gap-3 md:grid-cols-3">
            ...
            >
                ...
                <p
                    class="mt-1 text-sm font-semibold text-gray-900 capitalize dark:text-gray-100"
                >
