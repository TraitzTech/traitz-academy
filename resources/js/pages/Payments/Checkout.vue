...
<template>
    <div>
        ...
        <div class="grid grid-cols-1 gap-6 lg:grid-cols-3">
            <div
                class="rounded-xl bg-white p-6 shadow lg:col-span-2 dark:bg-gray-800"
            >
                <h3
                ...
                <form @submit.prevent="submit" class="space-y-5">
                    <div>
                        ...
                        <input
                            ...
                            class="w-full rounded-lg border border-gray-300 px-4 py-2.5 focus:border-transparent focus:ring-2 focus:ring-[#42b6c5] dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100"
                        />
                        <p
                        ...
                        <div class="space-y-3">
                            ...
                            >
                                <input
                                    ...
                                    value="installment"
                                    class="mr-2"
                                    :disabled="summary.max_installments <= 1"
                                />
                                <span
                                    class="font-semibold text-gray-900 dark:text-gray-100"
                    ...
                    <button
                        ...
                        class="inline-flex w-full items-center justify-center rounded-lg bg-[#42b6c5] px-6 py-3 font-semibold text-white transition-colors hover:bg-[#35919e] disabled:opacity-60"
                    >
            ...
            <div class="h-fit rounded-xl bg-white p-6 shadow dark:bg-gray-800">
                <h3
                ...
                <div class="space-y-3 text-sm">
                    <div class="flex justify-between">
                        ...
                        <span
                            ...
                            >{{ application.program.title }}</span
                        >
                    </div>
                    <div class="flex justify-between">
                        <span class="text-gray-500 dark:text-gray-400"
                        ...
                        <span
                            ...
                            >{{ formatMoney(summary.program_price) }}</span
                        >
                    </div>
                    <div class="flex justify-between">
                        <span class="text-gray-500 dark:text-gray-400"
