...
const backHref = computed(() =>
    adminRoles.includes(
        String((page.props as unknown as PageProps).auth?.user?.role ?? ''),
    )
        ? '/admin/dashboard'
        : '/dashboard#payments',
);
...
const printReceipt = () => {
    globalThis.window?.open(
        `/payments/receipts/${props.payment.id}/print`,
        '_blank',
    );
};
</script>
                    ...
                    <div class="space-y-2 text-sm">
                        <p class="flex justify-between gap-4">
                            ...
                            ><span
                                ...
                                {{ payment.application.last_name }}</span
                            >
                        </p>
                        <p class="flex justify-between gap-4">
                            <span class="text-gray-500 dark:text-gray-400"
                            ...
                            ><span
                                class="font-medium text-gray-900 dark:text-gray-100"
                                >{{ payment.application.email }}</span
                            >
                        </p>
                        <p class="flex justify-between gap-4">
                            <span class="text-gray-500 dark:text-gray-400"
                            ...
                            ><span
                                class="font-medium text-gray-900 dark:text-gray-100"
                                >{{ payment.application.program.title }}</span
                            >
                        </p>
                        <p class="flex justify-between gap-4">
                            <span class="text-gray-500 dark:text-gray-400"
                        ...
                        <p class="flex justify-between gap-4">
                            ...
                            ><span
                                ...
                                {{ payment.total_installments }}</span
                            >
                        </p>
                        <p class="flex justify-between gap-4">
                            <span class="text-gray-500 dark:text-gray-400"
