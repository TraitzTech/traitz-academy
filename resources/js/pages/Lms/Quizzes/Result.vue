...
function formatSubmitted(question: any) {
    ...
    if (question.type === 'multiple_select') {
        if (
            !Array.isArray(question.submitted) ||
            question.submitted.length === 0
        )
            return 'No answer';
        ...
        <div class="lms-page mx-auto max-w-3xl">
            <div class="lms-panel mb-6">
                ...
                <div class="mt-3 flex flex-wrap items-center gap-3 text-sm">
                    <span
                        :class="
                            attempt.passed
                                ...
                                : 'rounded-full bg-red-100 px-3 py-1 font-semibold text-red-700'
                        "
                    >
                    ...
                    <span class="text-gray-600 dark:text-gray-300"
                        >Pass mark (reference):
                        <strong>{{ quiz.pass_mark_percentage }}%</strong></span
                    >
                </div>
                <p
                    v-if="attempt.instructor_feedback"
                    class="mt-4 rounded-lg border border-[#42b6c5]/30 bg-[#42b6c5]/5 p-4 text-left text-sm text-gray-700 dark:text-gray-200"
                >
                    <span class="font-semibold text-[#000928] dark:text-white"
                        >Instructor feedback</span
                    ><br />
            ...
            <div class="space-y-4">
                ...
                >
                    ...
                    <p
                        v-if="quiz.reveal_answers && q.explanation"
                        class="lms-subtitle"
                    >
                        {{ q.explanation }}
                    </p>
