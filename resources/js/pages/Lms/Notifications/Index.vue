...
function titleFor(notification: AppNotification): string {
    return (
        notification.data?.subject || notification.data?.title || 'Notification'
    );
}
            ...
            <div class="flex flex-wrap items-center justify-between gap-3">
                <div>
                    ...
                    <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                        Announcements from admins and tutors, plus LMS activity
                        updates.
                    </p>
                </div>
                <button
        ...
        <div v-else class="space-y-3">
            ...
            >
                ...
                <div
                    ...
                    class="prose prose-sm max-w-none text-gray-700 dark:text-gray-300 dark:prose-invert"
