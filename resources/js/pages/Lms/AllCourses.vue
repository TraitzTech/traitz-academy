...
<template>
    <AppLayout
        :breadcrumbs="[{ title: 'Courses', href: '/dashboard/courses' }]"
    >
        ...
        <div class="lms-page">
            ...
            >
                <div>
                    ...
                    <p class="lms-subtitle">
                        Browse
                        <span class="font-semibold text-[#381998]">{{
                            courses.total
                        }}</span>
                        available courses across
                        <span class="font-semibold text-[#381998]">{{
                            categories.length
                        }}</span>
                        categories
                ...
                <div class="relative w-full sm:w-72">
                    ...
                    <input
                        ...
                        class="w-full rounded-xl border border-gray-200 bg-white py-2.5 pr-10 pl-10 text-sm text-gray-800 shadow-sm placeholder:text-gray-400 focus:border-[#42b6c5] focus:ring-2 focus:ring-[#42b6c5]/20 focus:outline-none dark:border-gray-700 dark:bg-gray-800 dark:text-white"
                    />
                    <button
                        v-if="search"
                        @click="search = ''"
            ...
            <div class="mb-5 flex flex-wrap items-center gap-3">
                <select
                    ...
                    class="rounded-xl border border-gray-200 bg-white px-3 py-2 text-sm text-gray-700 shadow-sm focus:border-[#42b6c5] focus:outline-none dark:border-gray-700 dark:bg-gray-800 dark:text-gray-200"
                >
                    <option
                ...
                <button
                    ...
                    :class="[
                        ...
                        filtersOpen
                            ...
                            : 'border-gray-200 bg-white text-gray-700 hover:border-[#42b6c5] hover:text-[#42b6c5] dark:border-gray-700 dark:bg-gray-800 dark:text-gray-200',
                    ]"
                >
                    ...
                    <span
                        ...
                        class="flex h-5 w-5 items-center justify-center rounded-full bg-[#42b6c5] text-xs font-bold text-white"
                    >
                        {{ activeFiltersCount }}
                    </span>
                </button>
            ...
            <div class="flex gap-6">
                <!-- Filter panel -->
                <aside v-if="filtersOpen" class="w-56 shrink-0">
                    <div class="sticky top-6 space-y-4">
                        <!-- Category -->
                        <div class="lms-panel p-4">
                            <h3
                                class="mb-3 text-xs font-bold tracking-wide text-[#000928] uppercase dark:text-white"
                            >
                                Category
                            </h3>
                ...
                <div class="min-w-0 flex-1">
                    ...
                    <div
                        ...
                        class="rounded-2xl border-2 border-dashed border-gray-200 bg-white py-20 text-center dark:border-gray-700 dark:bg-gray-800"
                    >
                        <BookOpen
                            class="mx-auto mb-4 h-12 w-12 text-gray-300"
                        />
                        <h3
                            class="mb-1 text-lg font-bold text-gray-700 dark:text-gray-200"
                        >
                            No courses found
                        </h3>
                    ...
                    >
                        <div
                            ...
                            :key="course.id"
                            class="group flex flex-col overflow-hidden rounded-2xl border border-gray-100 bg-white shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-lg dark:border-gray-700 dark:bg-gray-800"
                        >
                            <!-- Thumbnail -->
                            <div
                                class="relative h-40 overflow-hidden bg-gradient-to-br from-[#381998] to-[#42b6c5]"
                            >
                                <img
                                ...
                                <div
                                    ...
                                    class="absolute top-3 left-3 rounded-full bg-[#42b6c5] px-2.5 py-0.5 text-xs font-bold text-white shadow"
                                >
                                    Featured
                                </div>
                                <div
                                    v-if="course.category"
                                    class="absolute top-3 right-3 rounded-full bg-white/20 px-2.5 py-0.5 text-xs font-semibold text-white backdrop-blur-sm"
                                >
                            ...
                            <div class="flex flex-1 flex-col p-4">
                                ...
                                <h3
                                    class="mb-1 line-clamp-2 text-sm leading-snug font-bold text-[#000928] transition-colors group-hover:text-[#381998] dark:text-white dark:group-hover:text-[#42b6c5]"
                                >
                                    {{ course.title }}
                                </h3>
                                <p
                                    class="mb-3 line-clamp-2 text-xs text-gray-500"
                                >
                                ...
                                <div
                                    class="mb-4 flex flex-wrap items-center gap-3 text-xs text-gray-500"
                                >
                                    <span
                                ...
                                >
                                    <div>
                                        <span
                                            class="text-base font-bold text-[#000928] dark:text-white"
                                        >
                                            {{
                                                formatPrice(
                                                    course.price,
                            ...
                            <Link
                                ...
                                :class="[
                                    ...
                                    link.active
                                        ...
                                        : 'border border-gray-200 bg-white text-gray-600 hover:border-[#42b6c5] hover:text-[#42b6c5] dark:border-gray-700 dark:bg-gray-800 dark:text-gray-300',
                                ]"
