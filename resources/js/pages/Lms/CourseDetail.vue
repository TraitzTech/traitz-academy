...
const perInstallment = computed(() => {
    ...
    return (
        Math.round((effectivePrice.value / maxInstallments.value) * 100) / 100
    );
});

const firstLessonId = computed(
    () => props.course.sections[0]?.lessons[0]?.id ?? null,
);
</script>
...
<template>
    ...
    >
        ...
        <div class="lms-page">
            <section
                class="mb-8 overflow-hidden rounded-2xl bg-linear-to-br from-[#000928] via-[#1a0a52] to-[#381998] p-6 text-white shadow-lg"
            >
                <div class="grid gap-6 lg:grid-cols-5 lg:items-start">
                    <div class="lg:col-span-3">
                        ...
                        >
                            <span
                                ...
                                class="inline-flex items-center gap-1.5 rounded-full bg-white/15 px-3 py-1 font-semibold"
                            >
                                <component
                            ...
                            <span
                                class="rounded-full bg-white/15 px-3 py-1 font-semibold"
                                >{{ course.level }}</span
                            >
                        </div>
                    ...
                    <div
                        class="relative aspect-video overflow-hidden rounded-xl bg-white/10 lg:col-span-2"
                    >
                        <img
            ...
            <div class="grid gap-8 lg:grid-cols-3">
                <div class="space-y-6 lg:col-span-2">
                    <div v-if="course.description?.trim()" class="lms-panel">
                        <h2
                            class="mb-3 text-lg font-bold text-[#000928] dark:text-white"
                        >
                            About this course
                        </h2>
                        <div
                    ...
                    <div class="lms-panel">
                        ...
                        >
                            <Layers class="h-5 w-5 text-[#42b6c5]" /> Curriculum
                        </h2>
                        <div class="space-y-2">
                            <div
                            ...
                            >
                                <button
                                    type="button"
                                    class="flex w-full items-center justify-between bg-gray-50 px-4 py-3 text-left dark:bg-gray-900/40"
                ...
                <div class="space-y-6">
                    <div class="lms-panel">
                        <h3
                            class="mb-3 text-sm font-bold tracking-wide text-gray-500 uppercase"
                        >
                            Pricing
                        </h3>
                        <p
                            v-if="parseFloat(course.price) <= 0"
                        ...
                        <template v-else>
                            <p
                                class="text-3xl font-bold text-[#000928] dark:text-white"
                            >
                                {{
                                    money(
                        ...
                        <Link
                            ...
                            class="mt-3 flex w-full items-center justify-center rounded-xl border border-gray-200 py-2.5 text-sm font-semibold text-gray-600 transition-colors hover:bg-gray-50 dark:border-gray-600 dark:text-gray-300 dark:hover:bg-gray-700/50"
                        >
                            Back to all courses
                        </Link>
                    </div>
