...
<template>
    <AppLayout
        :breadcrumbs="[{ title: 'My Courses', href: '/dashboard/my-courses' }]"
    >
        ...
        <div class="lms-page">
            ...
            <div class="mb-6 grid grid-cols-3 gap-4">
                <div class="lms-panel p-4">
                    <div class="flex items-center gap-3">
                        <div
                            class="flex h-10 w-10 items-center justify-center rounded-lg bg-[#381998]/10"
                        >
                ...
                <div class="lms-panel p-4">
                    <div class="flex items-center gap-3">
                        <div
                            class="flex h-10 w-10 items-center justify-center rounded-lg bg-[#42b6c5]/10"
                        >
            ...
            >
                <!-- Status tabs -->
                <div
                    class="flex items-center gap-1 rounded-xl border border-gray-200 bg-white p-1 shadow-sm dark:border-gray-700 dark:bg-gray-800"
                >
                    <button
                ...
                <div class="relative w-full sm:w-64">
                    ...
                    <input
                        ...
                        class="w-full rounded-xl border border-gray-200 bg-white py-2 pr-10 pl-10 text-sm placeholder:text-gray-400 focus:border-[#42b6c5] focus:ring-2 focus:ring-[#42b6c5]/20 focus:outline-none dark:border-gray-700 dark:bg-gray-800 dark:text-white"
                    />
                    <button
                        v-if="search"
                        @click="search = ''"
            ...
            >
                ...
                >
                    <!-- Thumbnail -->
                    <div
                        class="relative h-40 overflow-hidden bg-linear-to-br from-[#381998] to-[#42b6c5]"
                    >
                        <img
                            v-if="
                                enrollment.course &&
                                coverUrl(enrollment.course.cover_image)
                            "
                        ...
                        <div
                            ...
                            :class="[
                                'absolute top-3 left-3 rounded-full px-2.5 py-0.5 text-xs font-bold shadow',
                                statusConfig[enrollment.access_status]?.class ??
                                    'bg-gray-100 text-gray-700',
                            ]"
                        >
                            {{
                                statusConfig[enrollment.access_status]?.label ??
                        ...
                        <!-- Completed icon -->
                        <div
                            v-if="enrollment.access_status === 'completed'"
                            class="absolute top-3 right-3"
                        >
                            <Award
                                class="h-6 w-6 text-yellow-300 drop-shadow"
                            />
                        </div>
                    </div>
                    ...
                    <div class="flex flex-1 flex-col p-4">
                        <template v-if="enrollment.course">
                            <div class="mb-2 flex items-center gap-2">
                                <span
                                    ...
                                    :class="[
                                        ...
                                        levelColors[enrollment.course.level],
                                    ]"
                                >
                            ...
                            >
                                <span
                                    v-if="enrollment.course.duration"
                        ...
                        <div class="mt-auto">
                            <div
                                ...
                                :class="{
                                    'sm:grid-cols-2':
                                        enrollment.course?.first_quiz_id,
                                }"
                            >
                                <Link
                                    :href="
