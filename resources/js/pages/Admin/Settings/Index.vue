...
const useMyLocation = () => {
    ...
    navigator.geolocation.getCurrentPosition(
        (pos) => {
            ...
            formData.value['office_longitude'] =
        ...
        () => {
            locating.value = false;
            toast.error(
                'Could not get your location. Allow location access and ensure you are on HTTPS.',
            );
        },
...
const currentSettings = computed(() => {
    const settings =
        props.settings?.[activeTab.value as keyof typeof props.settings];
    ...
    <div class="mx-auto max-w-6xl">
        ...
        >
            <div>
                ...
                <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                    Manage your site branding, content, and configuration
                </p>
            </div>
            <button
                @click="saveSettings"
        ...
        >
            ...
            <div class="p-6 sm:p-8">
                ...
                <div
                    v-if="activeTab === 'internship'"
                    class="mb-6 rounded-xl border border-dashed border-[#42b6c5]/50 bg-[#42b6c5]/[0.05] p-4"
                >
                    <p
                    ...
                    >
                        Interns can only clock in from the office. Stand at the
                        office and tap the button to capture its coordinates,
                        then Save. A ~100m safety buffer is added automatically
                        so interns aren't rejected by GPS drift.
                    </p>
                    <button
                        type="button"
                        :disabled="locating"
                ...
                >
                    ...
                    >
                        ...
                        <div v-else-if="setting.type === 'url'">
                            ...
                            <div
                                v-if="
                                    setting.key === 'youtube_video_url' &&
                                    formData[setting.key]
                                "
                                class="mt-4"
                            >
                                <div
                                    class="aspect-video overflow-hidden rounded-xl bg-gray-100 dark:bg-gray-700"
                                >
                                    <iframe
                                        :src="
                                            streamingEmbedSrc(
                                                formData[setting.key] ?? null,
                                            ) ?? ''
                                        "
                                        class="h-full w-full"
                                        frameborder="0"
                        ...
                        <div v-else-if="setting.type === 'image'">
                            ...
                            <div class="flex items-start gap-4">
                                ...
                                >
                                    <img
                                        :src="
                                            getImageUrl(formData[setting.key])
                                        "
                                        :alt="setting.label"
                                ...
                                <div>
                                    <label
                                        class="inline-flex cursor-pointer items-center gap-2 rounded-xl border border-dashed border-gray-300 px-4 py-2.5 text-sm text-gray-600 transition-colors hover:border-[#42b6c5] hover:bg-[#42b6c5]/[0.04] hover:text-[#42b6c5] dark:border-gray-600 dark:text-gray-300"
                                    >
                                        <Loader2
                    ...
                    >
                        ...
                        >
                            Settings will be added automatically when needed.
                        </p>
                    </div>
                </div>
            </div>
