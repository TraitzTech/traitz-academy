...
function confirmApprove() {
    ...
    router.post(
        `/admin/courses/${approveTarget.value.id}/approve`,
        {},
        {
            onSuccess: () => {
...
function confirmReject() {
    ...
    router.post(
        `/admin/courses/${rejectTarget.value.id}/reject`,
        {},
        {
            onSuccess: () => {
...
<template>
    <div>
            ...
            >
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p
                            class="mt-1 text-2xl font-bold text-[#000928] lg:text-3xl dark:text-gray-100"
                        >
                            {{ stats.total }}
                        </p>
                    </div>
        ...
        >
            <!-- Status tabs -->
            <div
                class="flex w-fit gap-1 rounded-xl bg-gray-100 p-1 dark:bg-gray-800"
            >
                <button
                    v-for="[val, label] in [
                        ['', 'All'],
            ...
            <div class="flex gap-2">
                <input
                    ...
                    class="w-48 rounded-lg border border-gray-300 px-3 py-1.5 text-sm focus:border-transparent focus:ring-2 focus:ring-[#42b6c5] dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100"
                />
                <select
                    v-model="category"
        ...
        <ConfirmationModal
            ...
            :description="
                approveTarget
                    ? `Approve &quot;${approveTarget.title}&quot;? It will go live immediately.`
                    : ''
            "
        ...
        <ConfirmationModal
            ...
            :description="
                rejectTarget
                    ? `Return &quot;${rejectTarget.title}&quot; to the tutor as a draft?`
                    : ''
            "
