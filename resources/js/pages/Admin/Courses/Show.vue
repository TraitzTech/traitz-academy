...
function confirmApprove() {
    router.post(
        `/admin/courses/${props.course.id}/approve`,
        {},
        {
            onSuccess: () => {
...
function confirmReject() {
    router.post(
        `/admin/courses/${props.course.id}/reject`,
        {},
        {
            onSuccess: () => {
...
function submitEnrollStudent() {
    enrollForm.post(`/admin/courses/${props.course.id}/enroll-student`, {
        preserveScroll: true,
    });
}
...
function onLessonVideoSelected(
    event: Event,
    sectionId: number,
    lessonId: number,
) {
...
function performVideoUpload(
    ...
    videoUploadForm.post(
        `/admin/courses/${props.course.id}/sections/${sectionId}/lessons/${lessonId}/video`,
        {
            forceFormData: true,
            preserveScroll: true,
            onSuccess: () => {
    ...
    <div class="mx-auto max-w-5xl">
        ...
        >
            <div>
                ...
                <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                    Read-only preview for admin review
                </p>
            </div>
        ...
        <div class="grid grid-cols-1 gap-6 lg:grid-cols-3">
            ...
            <div class="space-y-6 lg:col-span-2">
                <!-- Cover image -->
                <div
                    class="overflow-hidden rounded-xl bg-gradient-to-br from-[#381998] to-[#42b6c5] shadow"
                >
                    <img
                        v-if="coverSrc"
                        :src="coverSrc"
                ...
                <div class="rounded-lg bg-white p-6 shadow dark:bg-gray-800">
                    <div class="mb-4 flex flex-wrap items-center gap-2">
                        ...
                        <span
                            class="rounded-full border border-gray-200 px-3 py-0.5 text-xs font-medium text-gray-600 dark:border-gray-600 dark:text-gray-300"
                        >
                            {{ levelLabels[course.level] }}
                        </span>
                        <span
                            v-if="course.category"
                            class="inline-flex items-center gap-1.5 rounded-full px-3 py-0.5 text-xs font-semibold text-white"
                            :style="{
                                backgroundColor:
                                    course.category.color || '#381998',
                            }"
                        >
                            <component
                    ...
                    >
                        ...
                        <div
                            class="prose prose-sm max-w-none text-gray-600 dark:text-gray-400 dark:prose-invert"
                ...
                <div class="rounded-lg bg-white p-6 shadow dark:bg-gray-800">
                    ...
                    <div
                        ...
                        class="rounded-lg border-2 border-dashed border-gray-200 p-8 text-center dark:border-gray-600"
                    >
                            ...
                            >
                                ...
                                >
                                    <div class="flex items-center gap-3">
                                        <!-- Type icon -->
                                        <div
                                            class="flex h-8 w-8 shrink-0 items-center justify-center rounded-lg bg-[#42b6c5]/10 text-[#42b6c5]"
                                        >
                                            <svg
                                        ...
                                        <span
                                            v-if="lesson.is_free"
                                            class="shrink-0 rounded-full bg-green-100 px-2 py-0.5 text-xs font-semibold text-green-700 dark:bg-green-900/30 dark:text-green-400"
                                        >
                                            Free
                                        </span>
                                        <Link
                                    ...
                                    >
                                        <div
                                            class="yt-crop-shell aspect-video max-w-2xl overflow-hidden rounded-lg bg-black"
                                        >
                                            <iframe
                                                :src="
                                                    lessonEmbedUrl(lesson) ??
            ...
            <div class="space-y-5">
                ...
                <div class="rounded-lg bg-white p-5 shadow dark:bg-gray-800">
                    ...
                    >
                        <div
                            class="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-[#381998] text-sm font-bold text-white"
                        >
                ...
                <div class="rounded-lg bg-white p-5 shadow dark:bg-gray-800">
                    ...
                    <dl class="space-y-3">
                        <div class="flex justify-between text-sm">
                            ...
                            >
                                <span v-if="Number(course.price) === 0"
                                    >Free</span
                                >
                                <span v-else
                                    >{{
                ...
                >
                    ...
                    <p class="mb-3 text-xs text-gray-500 dark:text-gray-400">
                        Grant course access by email. The person must already
                        have a registered account with that email.
                    </p>
                    <form
                        class="space-y-3"
