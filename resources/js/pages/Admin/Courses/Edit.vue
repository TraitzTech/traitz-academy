    ...
    <div class="mx-auto max-w-5xl">
        ...
        <div class="mb-6">
            ...
            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                Update course details as admin
            </p>
        </div>
            ...
            <form class="space-y-4" @submit.prevent="save">
                ...
                <div>
                    ...
                    <p class="mb-2 text-xs text-gray-500 dark:text-gray-400">
                        Rich text — same formatting learners see on the course
                        page.
                    </p>
                    <RichTextEditor
                ...
                <div>
                    ...
                    <input
                        ...
                        type="text"
                        class="w-full max-w-md rounded-lg border border-gray-300 px-3 py-2 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100"
                    />
                    <p
                ...
                <div
                    class="rounded-lg border border-gray-200 bg-gray-50 p-4 text-sm text-gray-600 dark:border-gray-600 dark:bg-gray-900/40 dark:text-gray-400"
                >
                    ...
                    <p class="mt-1">
                        ...
                        <Link
                            ...
                            class="font-medium text-[#381998] hover:underline dark:text-[#42b6c5]"
                            >Admin → Courses → Pricing</Link
                        >.
                    </p>
                </div>
