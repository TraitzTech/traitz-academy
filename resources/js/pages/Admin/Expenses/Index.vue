...
const allSelected = computed({
    get: () =>
        props.expenses.data.length > 0 &&
        selectedIds.value.length === props.expenses.data.length,
    set: (val: boolean) => {
...
const chartMaxExpense = computed(() => {
    const maxExp = Math.max(
        ...props.chartData.monthly.map((m) => m.expenses),
        1,
    );
    const maxCol = Math.max(
        ...props.chartData.monthly.map((m) => m.collections),
        1,
    );
    ...
    <div>
            ...
            >
                <div>
                    ...
                    <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                        {{
                            isExecutive
                                ? 'Manage all organizational expenses and view financial overview'
                ...
                <div class="flex flex-wrap items-center gap-2">
                    ...
                    <button
                        ...
                        class="inline-flex items-center gap-2 rounded-lg bg-[#42b6c5] px-4 py-2 text-sm font-semibold text-white shadow-sm hover:bg-[#3aa3b1] focus:ring-2 focus:ring-[#42b6c5] focus:ring-offset-2 focus:outline-none"
                    >
                        <Plus class="h-4 w-4" />
                        Record Expense
                    </button>
            ...
            <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
                ...
                >
                    <div class="flex items-center justify-between">
                        ...
                        <div
                            class="rounded-full bg-orange-100 p-3 dark:bg-orange-900/30"
                        >
                            <DollarSign
            ...
            >
                ...
                >
                    ...
                    >
                        {{
                            isExecutive
                                ? 'Collections vs Expenses (12 months)'
                    ...
                    <div v-if="chartData.monthly.length > 0" class="space-y-2">
                        <!-- Chart legend -->
                        <div
                            class="mb-4 flex flex-wrap items-center gap-4 text-sm"
                        >
                        ...
                        <div class="flex gap-1 sm:gap-2" style="height: 200px">
                            ...
                            >
                                ...
                                <div
                                    ...
                                    :style="{
                                        height: `${Math.max((m.collections / chartMaxExpense) * 100, 2)}%`,
                                    }"
                                ...
                                <div
                                    ...
                                    :style="{
                                        height: `${Math.max((m.expenses / chartMaxExpense) * 100, 2)}%`,
                                    }"
                                ...
                                <!-- Month label -->
                                <span
                                    class="mt-1 text-center text-[9px] leading-tight text-gray-500 sm:text-[10px] dark:text-gray-400"
                                >
                                    {{ m.month.split(' ')[0] }}
                                </span>
                                ...
                                <!-- Tooltip -->
                                <div
                                    class="pointer-events-none absolute -top-20 left-1/2 z-10 hidden -translate-x-1/2 rounded-lg border border-gray-200 bg-white p-2 text-xs shadow-lg group-hover:block dark:border-gray-600 dark:bg-gray-700"
                                >
                                    <p
                                        class="font-semibold whitespace-nowrap text-gray-900 dark:text-white"
                                    >
                                        {{ m.month }}
                                    </p>
                                    <p class="text-red-500">
                                        Exp: {{ formatMoney(m.expenses) }}
                                    </p>
                                    <p
                                        v-if="isExecutive"
                                        class="text-green-500"
                                    >
                                        Col: {{ formatMoney(m.collections) }}
                                    </p>
                                </div>
                            </div>
                        </div>
                ...
                >
                    ...
                    <div
                        v-if="chartData.by_category.length > 0"
                        class="space-y-3"
                    >
                        <div
                        ...
                        >
                            ...
                            <p
                                class="mt-0.5 text-right text-[10px] text-gray-400"
                            >
                                {{
                                    categoryTotal > 0
                                        ? (
                                              (cat.amount / categoryTotal) *
                                              100
                                          ).toFixed(1)
                                        : 0
                                }}%
                        ...
                        <div class="flex items-center gap-2">
                            ...
                            >
                                ...
                                <span
                                    ...
                                    class="ml-1 rounded-full bg-[#42b6c5] px-1.5 py-0.5 text-[10px] font-bold text-white"
                                    >!</span
                                >
                            </button>
                    ...
                    <table class="w-full text-left text-sm">
                        ...
                        >
                            ...
                            >
                                ...
                                <td
                                    class="px-4 py-3 whitespace-nowrap text-gray-900 dark:text-white"
                                >
                                    {{ formatDate(expense.expense_date) }}
                                </td>
                                <td
                                    class="max-w-[200px] truncate px-4 py-3 font-medium text-gray-900 dark:text-white"
                                >
                                    {{ expense.title }}
                                    <p
                                        v-if="expense.receipt_reference"
                                ...
                                <td
                                    class="px-4 py-3 font-semibold whitespace-nowrap text-red-600 dark:text-red-400"
                                >
                                ...
                                <td
                                    class="max-w-[140px] truncate px-4 py-3 text-gray-600 dark:text-gray-400"
                                >
                                    {{ expense.vendor || '—' }}
                                </td>
                                <td
                ...
                <div class="space-y-3 p-4 md:hidden">
                    ...
                    >
                        ...
                        <div class="mt-3 flex flex-wrap items-center gap-2">
                            ...
                            <span
                                v-if="expense.payment_method"
                                class="rounded-full bg-gray-200 px-2 py-0.5 text-[10px] text-gray-600 dark:bg-gray-600 dark:text-gray-300"
                            >
                                {{ formatMethod(expense.payment_method) }}
                            </span>
                            <span
                        ...
                        <div class="mt-2 flex items-center justify-between">
                            ...
                            <div class="flex gap-1">
                                <button
                                    @click="openEdit(expense)"
                                    class="rounded-md p-1.5 text-gray-500 hover:text-[#42b6c5]"
                                >
                                    <Pencil class="h-4 w-4" />
                                </button>
                                <button
                                    @click="confirmDelete(expense)"
                                    class="rounded-md p-1.5 text-gray-500 hover:text-red-600"
                                >
                                    <Trash2 class="h-4 w-4" />
                                </button>
                            </div>
        ...
        <Dialog :open="showCreateModal" @update:open="showCreateModal = $event">
            <DialogContent class="max-h-[90vh] overflow-y-auto sm:max-w-lg">
                <DialogHeader>
                    ...
                    <DialogDescription
                        >Fill in the details below to record an
                ...
                <form @submit.prevent="submitCreate" class="space-y-4">
                    <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                        ...
                        <div>
                            ...
                            <p
                                v-if="createForm.errors.expense_category_id"
                                class="mt-1 text-xs text-red-500"
                            >
                        ...
                        <div>
                            ...
                            />
                            <p
                                v-if="createForm.errors.expense_date"
                                class="mt-1 text-xs text-red-500"
                            >
                        ...
                        <div>
                            ...
                            />
                            <p
                                v-if="createForm.errors.vendor"
                                class="mt-1 text-xs text-red-500"
                            >
                                {{ createForm.errors.vendor }}
                            </p>
                        </div>
                        ...
                        <div>
                            ...
                            />
                            <p
                                v-if="createForm.errors.receipt_reference"
                                class="mt-1 text-xs text-red-500"
                            >
                                {{ createForm.errors.receipt_reference }}
                            </p>
                        </div>
                        ...
                        <div v-if="isExecutive && adminUsers.length > 0">
                            ...
                            <p
                                v-if="createForm.errors.recorded_by"
                                class="mt-1 text-xs text-red-500"
                            >
                                {{ createForm.errors.recorded_by }}
                            </p>
                        </div>
        ...
        <Dialog :open="showEditModal" @update:open="showEditModal = $event">
            <DialogContent class="max-h-[90vh] overflow-y-auto sm:max-w-lg">
                <DialogHeader>
                    ...
                    <DialogDescription
                        >Update the expense details below.</DialogDescription
                    >
                </DialogHeader>
                ...
                <form @submit.prevent="submitEdit" class="space-y-4">
                    <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                        ...
                        <div>
                            ...
                            <p
                                v-if="editForm.errors.expense_category_id"
                                class="mt-1 text-xs text-red-500"
                            >
                        ...
                        <div>
                            ...
                            />
                            <p
                                v-if="editForm.errors.expense_date"
                                class="mt-1 text-xs text-red-500"
                            >
                        ...
                        <div v-if="isExecutive && adminUsers.length > 0">
                            ...
                            <p
                                v-if="editForm.errors.recorded_by"
                                class="mt-1 text-xs text-red-500"
                            >
                                {{ editForm.errors.recorded_by }}
                            </p>
                        </div>
        ...
        >
            <DialogContent class="sm:max-w-md">
                <DialogHeader>
                    <DialogTitle
                        >Delete {{ selectedIds.length }} Expense(s)</DialogTitle
                    >
                    <DialogDescription>
                        Are you sure you want to delete
                        {{ selectedIds.length }} selected expense(s)? This
