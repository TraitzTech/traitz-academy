            ...
            >
                <div>
                    ...
                    <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                        Manage expense categories used across all expense
                        records.
                    </p>
                </div>
                ...
                >
                    ...
                    >
                        ...
                        <div class="text-right">
                            ...
                            >
                                {{ formatMoney(cat.expenses_sum_amount) }}
                            </p>
                        </div>
                    </div>
                </div>
        ...
        <Dialog :open="showEditModal" @update:open="showEditModal = $event">
            <DialogContent class="sm:max-w-md">
                <DialogHeader>
                    ...
                    <DialogDescription
                        >Update the category details below.</DialogDescription
                    >
                </DialogHeader>
                ...
                <DialogHeader>
                    ...
                    <DialogDescription>
                        <template
                            v-if="
                                deletingCategory &&
                                deletingCategory.expenses_count > 0
                            "
                        >
                            This category has
                            {{ deletingCategory.expenses_count }} expense(s) and
                            cannot be deleted. Please reassign them first.
                        </template>
                        <template v-else>
