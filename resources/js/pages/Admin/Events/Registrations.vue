...
const applyFilters = debounce(() => {
    router.get(
        `/admin/events/${props.event.id}/registrations`,
        {
...
const confirmStatusChange = () => {
    ...
    router.patch(
        `/admin/events/${props.event.id}/registrations/${selectedRegistration.value.id}`,
        {
...
const sendReminder = () => {
    router.post(
        `/admin/events/${props.event.id}/send-reminder`,
        {},
        {
            onSuccess: () => {
...
const confirmBulkStatusChange = () => {
    router.post(
        `/admin/events/${props.event.id}/registrations/bulk-update`,
        {
...
const confirmBulkDelete = () => {
    router.post(
        `/admin/events/${props.event.id}/registrations/bulk-destroy`,
        {
            ids: selectedIds.value,
        },
        {
...
<template>
    <div>
                ...
                <div class="flex flex-wrap items-center gap-3">
                    ...
                    <template v-if="selectedIds.length > 0">
                        ...
                        <button
                            ...
                            class="inline-flex items-center rounded-lg bg-green-100 px-3 py-1.5 text-sm font-semibold text-green-700 transition-colors hover:bg-green-200 dark:bg-green-900/30 dark:text-green-400 dark:hover:bg-green-900/50"
                        >
                            Confirm
                        </button>
                        <button
                            @click="openBulkStatusModal('attended')"
                            class="inline-flex items-center rounded-lg bg-blue-100 px-3 py-1.5 text-sm font-semibold text-blue-700 transition-colors hover:bg-blue-200 dark:bg-blue-900/30 dark:text-blue-400 dark:hover:bg-blue-900/50"
                        >
                            Mark Attended
                        </button>
                        <button
                            @click="openBulkStatusModal('cancelled')"
                            class="inline-flex items-center rounded-lg bg-yellow-100 px-3 py-1.5 text-sm font-semibold text-yellow-700 transition-colors hover:bg-yellow-200 dark:bg-yellow-900/30 dark:text-yellow-400 dark:hover:bg-yellow-900/50"
                        >
                            Cancel
                        </button>
                        <button
                            @click="openBulkDeleteModal"
                            class="inline-flex items-center rounded-lg bg-red-600 px-3 py-1.5 text-sm font-semibold text-white transition-colors hover:bg-red-700"
                        >
                            <svg
                                class="mr-1 h-4 w-4"
                                fill="none"
                    ...
                    <template v-else>
                        ...
                        <button
                            ...
                            class="inline-flex items-center rounded-lg bg-[#42b6c5] px-4 py-2 font-semibold text-white transition-colors hover:bg-[#35919e]"
                        >
                            <svg
                                class="mr-2 h-5 w-5"
                                fill="none"
        ...
        <div class="mb-6 grid grid-cols-2 gap-4 md:grid-cols-5">
            <div
                class="rounded-lg bg-white p-4 text-center shadow dark:bg-gray-800"
            >
                        ...
                        <tr>
                            <th class="px-6 py-3 text-left">
                                <input
                                    ...
                                    class="h-4 w-4 rounded border-gray-300 text-[#42b6c5] focus:ring-[#42b6c5] dark:border-gray-600 dark:bg-gray-700"
                                />
                            </th>
                            <th
