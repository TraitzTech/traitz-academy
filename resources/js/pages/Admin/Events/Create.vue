...
<template>
  <div>
    ...
    <div class="mb-8">
      ...
      <h2 class="text-3xl font-bold text-gray-900">Create New Event</h2>
      <p class="text-gray-600 mt-2">Add a new event, webinar, or workshop</p>
    </div>
      ...
      <div class="bg-white rounded-lg shadow p-6">
        ...
        <div class="flex items-start gap-6">
          ...
          <div class="flex-1">
            ...
            />
            <p class="mt-2 text-sm text-gray-500">Recommended: 600x400px, max 2MB</p>
          </div>
        </div>
      </div>
