...
<template>
  <div>
    ...
    <div class="mb-8">
      ...
      <h2 class="text-3xl font-bold text-gray-900 dark:text-gray-100">Create New Event</h2>
      <p class="text-gray-600 dark:text-gray-400 mt-2">Add a new event, webinar, or workshop</p>
    </div>
    ...
    <form @submit.prevent="submit" class="space-y-8">
      ...
      <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div>
            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Event Date & Time *</label>
            <input
          ...
          <div>
            <label class="flex items-center mb-2">
              <input
                ...
                type="checkbox"
                class="rounded border-gray-300 dark:border-gray-600 text-[#42b6c5] focus:ring-[#42b6c5] dark:bg-gray-700"
              />
              <span class="ml-2 text-sm text-gray-700 dark:text-gray-300">This is an online event</span>
            </label>
          </div>
          ...
          <div class="md:col-span-2">
            ...
            <input
              ...
              type="text"
              class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-[#42b6c5] focus:border-transparent dark:bg-gray-700 dark:text-gray-100"
              :placeholder="form.is_online ? 'e.g., Zoom, Google Meet' : 'e.g., Traitz Academy Campus'"
            />
          ...
          <div class="md:col-span-2">
            ...
            <textarea
              ...
              rows="5"
              class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-[#42b6c5] focus:border-transparent dark:bg-gray-700 dark:text-gray-100"
              placeholder="2:00 PM - Welcome and Introduction&#10;2:15 PM - Main Topic..."
            ></textarea>
          </div>
        </div>
      </div>
      ...
      <!-- Event Image -->
      <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
        <h3 class="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-4">Event Image</h3>
