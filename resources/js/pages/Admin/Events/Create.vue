    ...
    <div class="mx-auto max-w-5xl">
        ...
        <div class="mb-8">
            ...
            <p class="mt-2 text-gray-600 dark:text-gray-400">
                Add a new event, webinar, or workshop
            </p>
        </div>
            ...
            <div class="rounded-lg bg-white p-6 shadow dark:bg-gray-800">
                ...
                <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                    ...
                    <div>
                        <label class="mb-2 flex items-center">
                            <input
                                ...
                                type="checkbox"
                                class="rounded border-gray-300 text-[#42b6c5] focus:ring-[#42b6c5] dark:border-gray-600 dark:bg-gray-700"
                            />
                            <span
                                class="ml-2 text-sm text-gray-700 dark:text-gray-300"
                                >This is an online event</span
                            >
                        </label>
                    </div>
                    ...
                    <div v-if="form.is_online" class="md:col-span-2">
                        ...
                        />
                        <p
                            v-if="form.errors.event_url"
                            class="mt-1 text-sm text-red-600"
                        >
                            {{ form.errors.event_url }}
                        </p>
                    </div>
