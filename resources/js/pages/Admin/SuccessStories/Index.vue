  ...
  <div>
    ...
    <div class="mb-8 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
      <div>
        ...
        <p class="text-gray-600 mt-2">Manage student testimonials displayed on the homepage</p>
      </div>
    ...
    <div class="bg-white rounded-lg shadow overflow-hidden">
      <div class="overflow-x-auto">
        <table class="min-w-full divide-y divide-gray-200">
          ...
          <tbody class="bg-white divide-y divide-gray-200">
            <tr v-for="story in stories.data" :key="story.id" :class="['hover:bg-gray-50', selectedIds.includes(story.id) ? 'bg-cyan-50' : '']">
              ...
              <td class="px-6 py-4 whitespace-nowrap">
                <div class="flex items-center">
                  ...
                  <div class="ml-4">
                    <div class="text-sm font-medium text-gray-900">{{ story.name }}</div>
              ...
              <td class="px-6 py-4">
                <div class="text-sm text-gray-600 max-w-xs truncate" :title="story.story">
                  "{{ story.story }}"
                </div>
              </td>
              ...
              <td class="px-6 py-4 whitespace-nowrap">
                <button
                  ...
                  :class="[
                    ...
                    story.is_active ? 'bg-green-100 text-green-800 hover:bg-green-200' : 'bg-red-100 text-red-800 hover:bg-red-200'
                  ]"
                >
      ...
      <!-- Pagination -->
      <div v-if="stories.links && stories.links.length > 3" class="bg-white px-4 py-3 border-t border-gray-200 sm:px-6">
            ...
            <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
              <div class="sm:flex sm:items-start">
                ...
                <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                  <h3 class="text-lg leading-6 font-medium text-gray-900">Delete Success Story</h3>
                  <div class="mt-2">
          ...
          <div class="relative inline-block align-middle bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:max-w-lg sm:w-full">
            <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
              <div class="sm:flex sm:items-start">
                ...
                <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                  <h3 class="text-lg leading-6 font-medium text-gray-900">Delete Multiple Stories</h3>
                  <div class="mt-2">
                    <p class="text-sm text-gray-500">
