...
const allSelected = computed(() => {
    return (
        ...
        selectedIds.value.length === props.stories.data.length
    );
});
...
const toggleStatus = (story: SuccessStory) => {
    router.post(
        `/admin/success-stories/${story.id}/toggle-status`,
        {},
        {
            preserveState: true,
            onSuccess: () => {
...
const confirmBulkDelete = () => {
    router.post(
        '/admin/success-stories/bulk-destroy',
...
<template>
    <div>
        ...
        >
            <div>
                ...
                <p class="mt-2 text-gray-600 dark:text-gray-400">
                    Manage student testimonials displayed on the homepage
                </p>
            </div>
        ...
        >
                                ...
                                <div class="flex items-center">
                                    <div class="h-12 w-12 flex-shrink-0">
                                        <img
                                            ...
                                            :src="
                                                story.image_url.startsWith(
                                                    'http',
                                                )
                                                    ? story.image_url
                                                    : `/storage/${story.image_url}`
                                            "
                                            :alt="story.name"
            ...
            <!-- Pagination -->
            <div
                v-if="stories.links && stories.links.length > 3"
        ...
        <Teleport to="body">
            ...
            >
                ...
                >
                    ...
                    ></div>
                    <div
                        class="relative inline-block transform overflow-hidden rounded-lg bg-white text-left align-middle shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg dark:bg-gray-800"
                    >
                        <div
                        ...
                        <div
                            class="gap-2 bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6 dark:bg-gray-700"
                        >
                            <button
                                @click="confirmDelete"
                            ...
                            <button
                                @click="showDeleteModal = false"
                                class="mt-3 inline-flex w-full justify-center rounded-md border border-gray-300 bg-white px-4 py-2 text-base font-medium text-gray-700 shadow-sm hover:bg-gray-50 focus:outline-none sm:mt-0 sm:w-auto sm:text-sm dark:border-gray-600 dark:bg-gray-800 dark:text-gray-300 dark:hover:bg-gray-700"
                            >
                                Cancel
                            </button>
                        </div>
