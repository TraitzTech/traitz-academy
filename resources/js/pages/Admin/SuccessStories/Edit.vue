...
<template>
  <div>
    ...
    <div class="mb-8">
      ...
      <h2 class="text-3xl font-bold text-gray-900 dark:text-gray-100">Edit Success Story</h2>
      <p class="text-gray-600 dark:text-gray-400 mt-2">Update the testimonial from {{ props.story.name }}</p>
    </div>

    <form @submit.prevent="submit" class="space-y-8">
      <!-- Person Information -->
      <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
        <h3 class="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-4">Person Information</h3>
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div>
            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Role / Job Title</label>
            <input
              v-model="form.role"
              type="text"
              class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-[#42b6c5] focus:border-transparent dark:bg-gray-700 dark:text-gray-100"
      ...
      <!-- Story -->
      <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
        <h3 class="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-4">Testimonial</h3>
        <div>
          <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Story / Quote *</label>
          <textarea
            v-model="form.story"
            rows="4"
            class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-[#42b6c5] focus:border-transparent dark:bg-gray-700 dark:text-gray-100"
          ...
          ></textarea>
          <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Maximum 1000 characters. Current: {{ form.story.length }}</p>
      ...
      <!-- Image -->
      <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
        <h3 class="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-4">Photo</h3>
        <div class="flex items-start gap-6">
          <div class="flex-shrink-0">
            <div v-if="imagePreview" class="w-24 h-24 rounded-full overflow-hidden">
              <img :src="imagePreview" alt="Preview" class="w-full h-full object-cover" />
            </div>
            <div v-else class="w-24 h-24 rounded-full bg-gray-200 dark:bg-gray-700 flex items-center justify-center">
          ...
          <div class="flex-1">
            ...
            <input
              ...
              class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-[#42b6c5] focus:border-transparent dark:bg-gray-700 dark:text-gray-100"
            />
            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Recommended: Square image, max 2MB. Leave empty to keep current image.</p>
          ...
          <div class="flex items-center">
            <label class="flex items-center cursor-pointer">
              <input
                ...
                type="checkbox"
                class="h-5 w-5 text-[#42b6c5] focus:ring-[#42b6c5] border-gray-300 dark:border-gray-600 rounded dark:bg-gray-700"
              />
              <span class="ml-3 text-sm font-medium text-gray-700 dark:text-gray-300">Publish on homepage</span>
            </label>
          </div>
        </div>
      </div>
