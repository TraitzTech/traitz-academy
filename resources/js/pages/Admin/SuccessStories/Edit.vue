...
const imagePreview = ref<string | null>(
    props.story.image_url
        ? props.story.image_url.startsWith('http')
            ? props.story.image_url
            : `/storage/${props.story.image_url}`
        : null,
);
...
const submit = () => {
    form.transform((data) => ({
        ...
        onError: () => {
            toast.error(
                'Failed to update story. Please check the form for errors.',
            );
        },
    });
};
    ...
    <div class="mx-auto max-w-5xl">
        ...
        <div class="mb-8">
            ...
            <p class="mt-2 text-gray-600 dark:text-gray-400">
                Update the testimonial from {{ props.story.name }}
            </p>
        </div>
            ...
            <div class="rounded-lg bg-white p-6 shadow dark:bg-gray-800">
                ...
                <div class="flex items-start gap-6">
                    ...
                    <div class="flex-1">
                        ...
                        >
                            Recommended: Square image, max 2MB. Leave empty to
                            keep current image.
                        </p>
                        <p
