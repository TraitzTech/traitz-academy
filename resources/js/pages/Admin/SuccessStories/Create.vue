...
<template>
  <div>
    ...
    <div class="mb-8">
      ...
      <h2 class="text-3xl font-bold text-gray-900 dark:text-gray-100">Add Success Story</h2>
      <p class="text-gray-600 dark:text-gray-400 mt-2">Add a new student testimonial to display on the homepage</p>
    </div>
        ...
        <div class="flex items-start gap-6">
          ...
          <div class="flex-1">
            ...
            <input
              ...
              class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-[#42b6c5] focus:border-transparent dark:bg-gray-700 dark:text-gray-100"
            />
            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Recommended: Square image, max 2MB</p>
