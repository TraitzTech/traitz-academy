...
const toggleActive = (swag: Swag) => {
    router.post(
        `/admin/ai-forge/swags/${swag.slug}/toggle-active`,
        {},
        {
            preserveState: true,
...
const toggleFeatured = (swag: Swag) => {
    router.post(
        `/admin/ai-forge/swags/${swag.slug}/toggle-featured`,
        {},
        {
            preserveState: true,
...
<template>
    <div>
        ...
        >
            <div>
                ...
                <p class="mt-2 text-gray-600 dark:text-gray-400">
                    Manage merchandise{{ event ? ` for ${event.title}` : '' }}
                </p>
            </div>
            <Link
                href="/admin/ai-forge/swags/create"
        ...
        >
                ...
                >
                    ...
                    >
                        ...
                        >
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <span
                                    class="rounded-full bg-purple-100 px-2 py-1 text-xs font-medium text-purple-800 dark:bg-purple-900/30 dark:text-purple-400"
                                    >{{
                            ...
                            >
                                {{ formatMoney(swag.price) }}
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <span
                                    :class="[
                                        'text-sm font-medium',
                                        swag.stock_quantity > 10
                                            ? 'text-green-600 dark:text-green-400'
                                            : swag.stock_quantity > 0
                                              ? 'text-amber-600 dark:text-amber-400'
                                              : 'text-red-600 dark:text-red-400',
                                    ]"
                                    >{{ swag.stock_quantity }}</span
                                >
                            </td>
                            <td
                            ...
                            >
                                ...
                                >
                                    <Link
                                        :href="`/admin/ai-forge/swags/${swag.slug}/edit`"
                                        class="text-[#42b6c5] hover:text-[#35919e]"
                                        >Edit</Link
                                    >
                                    <button
                                        @click="deleteSwag(swag)"
                        ...
                        <tr v-if="swags.data.length === 0">
                            ...
                            >
                                No swags found. Add your first swag item.
                            </td>
                        </tr>
                    </tbody>
                </table>
            ...
            <!-- Pagination -->
            <div
                v-if="swags.links && swags.links.length > 3"
            ...
            >
                <div class="flex items-center justify-center">
                    ...
                    >
                        <Link
                            v-for="(link, index) in swags.links"
                            :key="index"
                            :href="link.url || '#'"
                            :class="[
        ...
        <ConfirmationModal
            ...
            title="Delete Swag"
            :description="`Are you sure you want to delete &quot;${swagToDelete?.name}&quot;? This cannot be undone.`"
            confirm-text="Delete"
            variant="destructive"
