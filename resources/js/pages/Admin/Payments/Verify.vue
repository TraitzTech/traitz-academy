...
<template>
    <div>
        ...
        <div class="mb-8 flex flex-wrap items-center justify-between gap-3">
            <div>
                ...
                <p class="mt-1 text-gray-600 dark:text-gray-400">
                    Search by receipt number, reference, or transaction id.
                </p>
            </div>
            <Link
                href="/admin/payments"
        ...
        <div class="mb-6 rounded-lg bg-white p-6 shadow dark:bg-gray-800">
            ...
            >
                <input
                    ...
                    class="flex-1 rounded-lg border border-gray-300 bg-white px-4 py-2 text-gray-900 focus:border-transparent focus:ring-2 focus:ring-[#42b6c5] dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100"
                />
                <button
                    type="submit"
                    class="rounded-lg bg-[#42b6c5] px-5 py-2 font-medium text-white transition-colors hover:bg-[#35919e]"
                >
                    Verify
                </button>
            </form>
        ...
        <div
            v-if="props.search && !payment"
            class="rounded-lg bg-white p-6 text-center text-red-600 shadow dark:bg-gray-800 dark:text-red-400"
        >
        ...
        <div
            v-if="payment"
            class="space-y-4 rounded-lg bg-white p-6 shadow dark:bg-gray-800"
        >
            ...
            <div class="grid grid-cols-1 gap-4 text-sm md:grid-cols-2">
                ...
                <p class="text-gray-700 md:col-span-2 dark:text-gray-300">
                    <span class="text-gray-500 dark:text-gray-400"
                        >Transaction ID:</span
                    >
                ...
                <p
                    ...
                    class="text-gray-700 md:col-span-2 dark:text-gray-300"
                >
                    <span class="text-gray-500 dark:text-gray-400"
                        >Collected By:</span
                    >
                    ...
                    <span
                        v-if="
                            payment.recorded_by?.role ||
                            payment.updated_by?.role
                        "
