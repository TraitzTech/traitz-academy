...
const allSelected = computed(() => {
    return (
        props.programs.data.length > 0 &&
        selectedIds.value.length === props.programs.data.length
    );
});
        ...
        >
            <div>
                ...
                <p class="mt-2 text-gray-600 dark:text-gray-400">
                    Create, edit, and manage all training programs
                </p>
            </div>
                ...
                >
                        ...
                        <tr>
                            <th class="px-6 py-3 text-left">
                                <input
                                    ...
                                    class="h-4 w-4 rounded border-gray-300 text-[#42b6c5] focus:ring-[#42b6c5] dark:border-gray-600"
                                />
                            </th>
                            <th
                    ...
                    >
                        ...
                        <tr v-if="programs.data.length === 0">
                            ...
                            >
                                No programs found. Create your first program to
                                get started.
                            </td>
                        </tr>
                    </tbody>
