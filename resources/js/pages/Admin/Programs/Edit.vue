...
<template>
  <div>
    ...
    <div class="mb-8">
      ...
      <h2 class="text-3xl font-bold text-gray-900 dark:text-gray-100">Edit Program</h2>
      <p class="text-gray-600 dark:text-gray-400 mt-2">Update program details</p>
    </div>
      ...
      <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
        ...
        <div class="flex items-start gap-6">
          ...
          <div class="flex-1">
            ...
            />
            <p class="mt-2 text-sm text-gray-500 dark:text-gray-400">Leave empty to keep current image. Recommended: 600x400px, max 2MB</p>
