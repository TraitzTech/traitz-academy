...
const form = useForm({
  ...
  program_id: props.interview.program_id || '' as string | number,
  passing_score: props.interview.passing_score,
  time_limit_minutes: props.interview.time_limit_minutes,
  is_active: props.interview.is_active,
  questions: props.interview.questions.map(q => ({
    id: q.id,
    question: q.question,
    type: q.type,
...
<template>
  <div>
    ...
    <div class="mb-8">
      ...
      <h2 class="text-3xl font-bold text-gray-900 dark:text-gray-100">Edit Interview</h2>
      <p class="text-gray-600 dark:text-gray-400 mt-2">Update interview details and questions</p>
    </div>
