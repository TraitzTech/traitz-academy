...
<template>
    <div class="mx-auto max-w-5xl">
        <Head
            :title="`Edit Application - ${application.first_name} ${application.last_name}`"
        />

        <div class="mb-8">
            <Link
                :href="`/admin/applications/${application.id}`"
                class="mb-2 inline-flex items-center text-[#42b6c5] hover:text-[#35919e]"
            >
                ← Back to Application
            </Link>
            ...
            <p class="mt-1 text-gray-600 dark:text-gray-400">
                Update applicant details, status, and selected program.
            </p>
        </div>
        ...
        <form @submit.prevent="submit" class="space-y-6">
            <div class="rounded-lg bg-white p-6 shadow dark:bg-gray-800">
                ...
                <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                    <div class="md:col-span-2">
                        ...
                        >
                            Changing program clears scheduled interview
                            information.
                        </p>
                        <p
            ...
            <div class="flex items-center justify-end gap-3">
                ...
                <button
                    ...
                    class="rounded-lg bg-[#42b6c5] px-5 py-2 font-medium text-white hover:bg-[#35919e] disabled:opacity-60"
                >
