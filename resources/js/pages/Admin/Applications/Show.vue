  ...
  <div>
    ...
    <div class="mb-8 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
      <div>
        ...
        <h2 class="text-3xl font-bold text-gray-900">Application Details</h2>
        <p class="text-gray-600 mt-1">Submitted on {{ formatDate(application.created_at) }}</p>
      </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
      ...
      <div class="lg:col-span-2 space-y-6">
        ...
        <div class="bg-white rounded-lg shadow p-6">
          <h3 class="text-lg font-semibold text-gray-900 mb-4 pb-2 border-b">Applicant Information</h3>
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <label class="block text-sm font-medium text-gray-500">Full Name</label>
              <p class="mt-1 text-gray-900">{{ application.first_name }} {{ application.last_name }}</p>
            </div>
            <div>
            ...
            <div>
              ...
              <p class="mt-1 text-gray-900">{{ [application.city, application.country].filter(Boolean).join(', ') || 'Not provided' }}</p>
            </div>
          </div>
        </div>
        ...
        <!-- Background -->
        <div class="bg-white rounded-lg shadow p-6">
          <h3 class="text-lg font-semibold text-gray-900 mb-4 pb-2 border-b">Background</h3>
          <div class="space-y-6">
            <div>
              <label class="block text-sm font-medium text-gray-500">Education Level</label>
              <p class="mt-1 text-gray-900">{{ application.education_level || 'Not provided' }}</p>
            </div>
            <div>
              <label class="block text-sm font-medium text-gray-500">Relevant Experience</label>
              <p class="mt-1 text-gray-900 whitespace-pre-line">{{ application.experience || 'Not provided' }}</p>
            </div>
          </div>
        </div>
        ...
        <!-- Motivation -->
        <div class="bg-white rounded-lg shadow p-6">
          <h3 class="text-lg font-semibold text-gray-900 mb-4 pb-2 border-b">Motivation</h3>
          <p class="text-gray-900 whitespace-pre-line">{{ application.motivation || 'Not provided' }}</p>
        </div>

        <!-- Review Notes (if rejected) -->
        <div v-if="application.notes" class="bg-white rounded-lg shadow p-6 border-l-4 border-red-500">
          <h3 class="text-lg font-semibold text-gray-900 mb-4 pb-2 border-b">Review Notes</h3>
      ...
      <div class="space-y-6">
        <!-- Program Info -->
        <div class="bg-white rounded-lg shadow p-6">
          <h3 class="text-lg font-semibold text-gray-900 mb-4 pb-2 border-b">Applied Program</h3>
          <div class="space-y-4">
            <div>
            ...
            <div>
              ...
              <p class="mt-1 text-gray-900 font-semibold">{{ formatPrice(application.program?.price || 0) }}</p>
            </div>
            <div v-if="application.program?.start_date">
              <label class="block text-sm font-medium text-gray-500">Program Dates</label>
        ...
        <!-- Review Status -->
        <div class="bg-white rounded-lg shadow p-6">
          <h3 class="text-lg font-semibold text-gray-900 mb-4 pb-2 border-b">Review Status</h3>
          <div class="space-y-4">
            <div>
            ...
            <div v-if="application.reviewed_at">
              ...
              <p class="mt-1 text-gray-900">{{ formatDate(application.reviewed_at) }}</p>
            </div>
            <div v-if="application.reviewer">
              <label class="block text-sm font-medium text-gray-500">Reviewed By</label>
        ...
        <!-- Linked User -->
        <div v-if="application.user" class="bg-white rounded-lg shadow p-6">
          <h3 class="text-lg font-semibold text-gray-900 mb-4 pb-2 border-b">Linked Account</h3>
          <div class="space-y-2">
