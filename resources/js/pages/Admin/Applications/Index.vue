...
<template>
  <div>
    ...
    <!-- Header -->
    <div class="mb-8">
      <h2 class="text-3xl font-bold text-gray-900">Application Reviews</h2>
      <p class="text-gray-600 mt-2">Review and manage all program applications</p>
    </div>
        ...
        <table class="min-w-full divide-y divide-gray-200">
          ...
          <tbody class="bg-white divide-y divide-gray-200">
            <tr v-for="app in applications.data" :key="app.id" class="hover:bg-gray-50">
              ...
              <td class="px-6 py-4 whitespace-nowrap">
                <div class="text-sm text-gray-900">{{ app.program?.title || 'N/A' }}</div>
              </td>
