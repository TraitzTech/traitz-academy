...
<template>
    ...
    >
        <h3 class="text-sm font-semibold text-[#000928] dark:text-white">
            Recordings
        </h3>
        <div
            v-if="recordings.length === 0"
            class="mt-3 rounded-lg border border-dashed border-gray-200 p-3 text-xs text-gray-500 dark:border-gray-600"
        >
            No recordings yet.
        </div>
