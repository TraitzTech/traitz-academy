...
import { BookOpen, FileText, Upload, Video } from 'lucide-vue-next';
...
const availableSections = computed<Section[]>(() => {
    ...
    const course = props.courses?.find(
        (c) => String(c.id) === String(props.form.course_id),
    );
    ...
    <div class="space-y-5">
        ...
        <div v-if="showSectionSelection">
            ...
            <select
                ...
                class="w-full rounded-lg border border-gray-300 px-4 py-2 focus:border-transparent focus:ring-2 focus:ring-[#42b6c5] disabled:opacity-50 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100"
                    ...
                    {{
                        form.course_id
                            ? availableSections.length
                                ? 'Select section…'
                                : 'No sections — add one in course editor'
        ...
        <div v-if="form.type === 'video' && showVideoUpload">
                ...
                >
                    ...
                    <label for="video-upload" class="cursor-pointer">
                        <Upload
                            ...
                            :class="
                                dragActive ? 'text-[#42b6c5]' : 'text-gray-400'
                            "
                        />
                        <p
                            v-if="form.video_file"
                            class="text-sm font-medium text-[#42b6c5]"
                        >
            ...
            <p class="mt-1 text-xs text-gray-400">
                File is uploaded and attached to this lesson for in-platform
                playback.
            </p>
        </div>
        ...
        <div v-if="form.type === 'text'" class="max-w-4xl">
            ...
            <p class="mb-2 text-xs text-gray-500 dark:text-gray-400">
                Rich text editor: headings, lists, code blocks, images, and
                links—same formatting learners see in the course player.
            </p>
            <RichTextEditor
        ...
        <div>
            ...
            <textarea
                ...
                class="w-full resize-none rounded-lg border border-gray-300 px-4 py-2 text-sm focus:border-transparent focus:ring-2 focus:ring-[#42b6c5] dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100"
            />
        </div>
